  ...
  return (
    <div className="App"> 
      <Routes>
        ...
        <Route path="/c/" element={<Category setSelectedCategory={setSelectedCategory} />} />
        
        <Route path="/c/:categoryName" element={<Post selectedCategory={selectedCategory} />} />
        
        <Route path="/c/:categoryName/:fileName" element={<Read />} />
      </Routes>
    </div>
  );
}
